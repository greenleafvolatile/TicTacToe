...
public class Tic_Tac_Toe_Single_Player_Version_1_0_1 extends JFrame {
    ...
    /**
     * This mouseAdapter registers mouse presses on individual TicTacToe tiles.
     */
    class TicTacToeListener extends MouseAdapter {

        public void mousePressed(MouseEvent e){

            Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1 tile=(Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1) e.getSource();
            System.out.print(tile.isFilled());
            if(!tile.isFilled()){
                if(Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1.isFirstMove()){
                    Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1.startGame();
                }
                tile.draw();
    ...
    /**
     * This method adds the TicTacToe components/tiles to the UI game grid.
     */
    public void addTiles(){

        for(int i=0;i<NUMBER_OF_ROWS;i++){
            for(int j=0;j<NUMBER_OF_COLUMNS;j++){
                JComponent tile =new Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1(i, j);
    ...
    /**
     * This method assigns a value to the element in the ticTacToeGrid that corresponds to the row and column values of the TicTacToe component that generated a mousePressed() event.
    ...
    public void markOnGrid(int row, int column){
        if(Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1.isNoughts()){
            ticTacToeGrid[row][column]=NOUGHTS_VALUE;
        }
        else if(!Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1.isNoughts()){
    ...
    public void checkEndGameConditions() {
        int gridValue= Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1.isNoughts() ? NOUGHTS_VALUE : CROSSES_VALUE;
    ...
    public void displayEndOfGameMessage(){
        ...
        String title="";
        if(gameWon) {
            String winner = Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1.isNoughts() ? "Noughts" : "Crosses";
     ...
     */
    public void restart(){
        Tic_Tac_Toe_Tile_Single_Player_Version_1_0_1.resetGame();
        this.gameWon=false;
        this.squaresFilled=0;
        this.resetGrid();
        this.repaint();
